#!/usr/bin/env bash
# vanilla on the 100-row set, pinned to the codex backend; prints the Stage 3 score.
# Inputs: --no-add-context
#   ./run_vanilla_100.sh            # codex, 8 workers
#   LIMIT=5 ./run_vanilla_100.sh    # quick wiring check on 5 rows
set -euo pipefail
