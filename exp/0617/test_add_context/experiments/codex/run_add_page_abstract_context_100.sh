#!/usr/bin/env bash
# add_page_abstract_context on the 100-row set, pinned to the codex backend; prints the Stage 3 score.
# Inputs: --add-page-abstract --add-context  (context-mode omitted -> pipeline default = all)
#   CONC=2 ./run_add_page_abstract_context_100.sh     # codex: lower concurrency to avoid throttling
