#!/usr/bin/env bash
# add_context on the 100-row set, pinned to the codex backend; prints the Stage 3 score.
# Inputs: --add-context --context-mode all
#   ./run_add_context_100.sh            # codex, 8 workers
#   LIMIT=5 ./run_add_context_100.sh    # quick wiring check on 5 rows
set -euo pipefail
