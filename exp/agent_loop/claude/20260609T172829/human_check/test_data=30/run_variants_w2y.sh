#!/usr/bin/env bash
# Run ST4 prompt variants on human_check/data/within_2y_extra.json (10 within_2_years examples)

set -euo pipefail

ROOT="/workspace/esg_contest"
SCRIPT="$ROOT/core/human/predict/stage4/pred_by_codex.py"
DATA="$ROOT/exp/agent_loop/claude/20260609T172829/human_check/data/within_2y_extra.json"
OUT_BASE="$ROOT/exp/agent_loop/claude/20260609T172829/human_check/results_w2y"
